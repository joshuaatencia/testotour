...
<body>
  ...
  <form action="/login" method="post">
    ...
    <small class="error">Campo de usuario obligatorio</small>
    @endif
    <input type="password" name="Contraseña" placeholder="Contraseña" value="{{ old('Contraseña')}}"><br>
    @if ($errors->has('Contraseña'))
        <small class="error">Campo de contraseña obligatorio</small>
    @endif
